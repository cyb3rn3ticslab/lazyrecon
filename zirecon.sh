...
ALTDNSWORDLIST=./wordlists/altdns_wordlist_uniq.txt
BRUTEDNSWORDLIST=./wordlists/six2dez_wordlist.txt
APIWORDLIST=./wordlists/api.txt
DIRSEARCHWORDLIST=./wordlists/directory-list-lowercase-2.3-big.txt
LFIPAYLOAD=./wordlists/lfi-payload.txt
PARAMSLIST=./wordlists/params-list.txt
